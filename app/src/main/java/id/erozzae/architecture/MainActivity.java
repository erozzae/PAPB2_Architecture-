package id.erozzae.architecture;
...
import id.erozzae.architecture.viewModels.DogRandomViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        observedDogVM(dogRandomViewModel);
    ...
    private void observedDogVM(DogRandomViewModel vm) {
        vm.getDogRandomResponseLiveData().observe(this,dogRandomResponse -> {
